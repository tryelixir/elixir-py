...
from elixir.sdk.tracing import get_tracer, set_workflow_name
from elixir.sdk.tracing.tracing import (
    TracerWrapper,
    set_entity_name,
    get_chained_entity_name,
)
from elixir.sdk.utils import camel_to_snake
    ...
    def decorate(fn):
        ...
        def wrap(*args, **kwargs):
            ...
            with get_tracer() as tracer:
                ...
                span.set_attribute(SpanAttributes.ELIXIR_SPAN_KIND, tlp_span_kind.value)
                span.set_attribute(
                    SpanAttributes.ELIXIR_ENTITY_NAME, chained_entity_name
                )
                ...
                try:
                    if _should_send_prompts():
                        span.set_attribute(
                            SpanAttributes.ELIXIR_ENTITY_OUTPUT, json.dumps(res)
                        )
                except TypeError as e:
                    Telemetry().log_exception(e)
        ...
        async def wrap(*args, **kwargs):
            ...
            with get_tracer() as tracer:
                with tracer.start_as_current_span(span_name) as span:
                    span.set_attribute(
                        SpanAttributes.ELIXIR_SPAN_KIND, tlp_span_kind.value
                    )
                    span.set_attribute(SpanAttributes.ELIXIR_ENTITY_NAME, name)
...
def _should_send_prompts():
    return (
        os.getenv("ELIXIR_TRACE_CONTENT") or "true"
